...
void GameState::Enter()
{
	...
	cout << "Gamestate initialization complete" << endl;
}
...
void TitleState::Enter()
{
	...
	FOMA::RegisterFont("IMG/LTYPE.TTF", "ltype", 16);
	m_pName = new Label("ltype", 200, 50, " ");
	std::string name = "Oliver Ventura - 101268251 & Deepankar (ENTER STUDENT # HERE)";
	m_pName->SetText(name.c_str());
}
